...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'quiz_choose_category': 'Choose a quiz',
      'quiz_choose_category_sub':
          'General questions about Nizwa Castle, or questions about the Imam\'s room.',
      'quiz_category_general': 'General',
      'quiz_category_general_sub': 'Nizwa Castle history and features',
      'quiz_category_imam': 'Imam\'s room',
      'quiz_category_imam_sub': 'Story and questions about the Imam\'s room',
      'quiz_no_questions': 'No questions in this category yet.',
      'manage_quiz_title': 'Manage quiz questions',
      'manage_quiz_card_title': 'Manage quiz questions',
      'manage_quiz_card_subtitle':
          'Add, edit, or delete quiz questions in English and Arabic',
      'manage_quiz_add_question': 'Add question',
      'manage_quiz_edit_question': 'Edit question',
      'manage_quiz_question_en': 'Question (English)',
      ...
      'manage_quiz_view_only_hint':
          'View only — you cannot add, edit, or delete questions.',
      'manage_quiz_fill_required':
          'Please fill in the question in both languages.',
      'manage_quiz_delete_q': 'Delete this question?',
      'manage_quiz_delete_msg': 'This cannot be undone.',
      'manage_quiz_sync_btn': 'Upload default questions to database',
      'manage_quiz_sync_done': 'Uploaded {count} question(s) to the database.',
      'manage_quiz_sync_error': 'Upload failed: {error}',
      'admin_perm_manage_quiz': 'Manage quiz questions',
      'admin_perm_can_manage_quiz': 'Add & delete',
      'manage_media_title': 'Manage media',
      'manage_media_card_title': 'Manage media',
      'manage_media_card_subtitle': 'Add, edit, or delete media name and URL',
      'manage_media_add': 'Add media',
      'manage_media_edit': 'Edit media',
      'manage_media_name': 'Media name',
      'manage_media_url': 'URL',
      'manage_media_saved': 'Saved',
      'manage_media_empty': 'No media yet. Tap + to add one.',
      'manage_media_view_only_hint':
          'View only — you cannot add, edit, or delete media.',
      ...
      'admin_edit_permissions': 'Edit page access',
      'admin_permissions_title': 'Access for {name}',
      'admin_permissions_subtitle':
          'Choose which admin pages this user can open and what they can do.',
      'admin_permissions_save': 'Save access',
      'admin_permissions_saved': 'Admin access updated',
      'admin_perm_feedback': 'Feedback',
      'admin_perm_user_support': 'User support (disabled accounts)',
      'admin_perm_leaderboard': 'Leaderboard',
      'admin_perm_analytics': 'Analytics',
      'admin_perm_manage_users': 'Manage users',
      'admin_perm_hidden': 'Hidden',
      'admin_perm_view_only': 'View only',
      'admin_perm_can_delete': 'View & delete',
      'admin_perm_can_enable': 'View & enable',
    ...
    'ar': {
      ...
      'quiz_choose_category': 'اختر الاختبار',
      'quiz_choose_category_sub':
          'أسئلة عامة عن قلعة نزوى، أو أسئلة عن غرفة الإمام.',
      'quiz_category_general': 'عام',
      'quiz_category_general_sub': 'تاريخ قلعة نزوى ومعالمها',
      'quiz_category_imam': 'غرفة الإمام',
      'quiz_category_imam_sub': 'قصة وأسئلة عن غرفة الإمام',
      'quiz_no_questions': 'لا توجد أسئلة في هذا القسم بعد.',
      'manage_quiz_title': 'إدارة أسئلة الاختبار',
      'manage_quiz_card_title': 'إدارة أسئلة الاختبار',
      'manage_quiz_card_subtitle':
          'إضافة أو تعديل أو حذف أسئلة الاختبار بالإنجليزية والعربية',
      'manage_quiz_add_question': 'إضافة سؤال',
      'manage_quiz_edit_question': 'تعديل السؤال',
      'manage_quiz_question_en': 'السؤال (إنجليزي)',
      'manage_quiz_question_ar': 'السؤال (عربي)',
      'manage_quiz_option_en': 'الخيار {n} (إنجليزي)',
      'manage_quiz_option_ar': 'الخيار {n} (عربي)',
      'manage_quiz_explanation_en': 'التفسير (إنجليزي) — لماذا هذا الجواب صحيح',
      'manage_quiz_explanation_ar': 'التفسير (عربي) — لماذا هذا الجواب صحيح',
      'manage_quiz_saved': 'تم الحفظ',
      'manage_quiz_empty': 'لا توجد أسئلة بعد. اضغط + لإضافة سؤال.',
      'manage_quiz_view_only_hint':
          'عرض فقط — لا يمكنك الإضافة أو التعديل أو الحذف.',
      'manage_quiz_fill_required': 'يرجى إدخال السؤال باللغتين.',
      'manage_quiz_delete_q': 'حذف هذا السؤال؟',
      'manage_quiz_delete_msg': 'لا يمكن التراجع عن هذا الإجراء.',
      'manage_quiz_sync_btn': 'رفع الأسئلة الافتراضية إلى قاعدة البيانات',
      'manage_quiz_sync_done': 'تم رفع {count} سؤالاً إلى قاعدة البيانات.',
      'manage_quiz_sync_error': 'فشل الرفع: {error}',
      'admin_perm_manage_quiz': 'إدارة أسئلة الاختبار',
      'admin_perm_can_manage_quiz': 'إضافة وحذف',
      'manage_media_title': 'إدارة الوسائط',
      'manage_media_card_title': 'إدارة الوسائط',
      'manage_media_card_subtitle': 'إضافة أو تعديل أو حذف اسم الوسائط والرابط',
      'manage_media_add': 'إضافة وسائط',
      'manage_media_edit': 'تعديل الوسائط',
      'manage_media_name': 'اسم الوسائط',
      'manage_media_url': 'الرابط',
      'manage_media_saved': 'تم الحفظ',
      'manage_media_empty': 'لا توجد وسائط بعد. اضغط + لإضافة وسائط.',
      'manage_media_view_only_hint':
          'عرض فقط — لا يمكنك الإضافة أو التعديل أو الحذف.',
      ...
      'admin_edit_permissions': 'تعديل صلاحيات الصفحات',
      'admin_permissions_title': 'صلاحيات {name}',
      'admin_permissions_subtitle':
          'اختر الصفحات التي يمكن لهذا المشرف فتحها وما يمكنه فعله.',
      'admin_permissions_save': 'حفظ الصلاحيات',
      'admin_permissions_saved': 'تم تحديث صلاحيات المشرف',
      'admin_perm_feedback': 'الملاحظات',
      'admin_perm_user_support': 'دعم المستخدمين (حسابات معطّلة)',
      'admin_perm_leaderboard': 'لوحة المتصدرين',
      'admin_perm_analytics': 'التحليلات',
      'admin_perm_manage_users': 'إدارة المستخدمين',
      'admin_perm_hidden': 'مخفي',
      'admin_perm_view_only': 'عرض فقط',
      'admin_perm_can_delete': 'عرض وحذف',
      'admin_perm_can_enable': 'عرض وتفعيل',
      'admin_no_pages_access':
          'لا يمكنك الوصول إلى أي صفحة إدارية. تواصل مع المشرف الأعلى.',
      'admin_feedback_delete_q': 'حذف الملاحظة؟',
      'admin_feedback_delete_msg': 'سيتم حذف هذه الملاحظة نهائياً.',
      'admin_feedback_delete_btn': 'حذف',
      'admin_feedback_deleted': 'تم حذف الملاحظة',
      // Admin analytics (charts)
